use bevy::{input::ButtonState, prelude::KeyCode};
use winit::event::{ElementState, VirtualKeyCode};

pub const fn convert_element_state(state: ElementState) -> ButtonState {
    match state {
...
pub const fn convert_virtual_keycode(keycode: VirtualKeyCode) -> KeyCode {
    match keycode {
